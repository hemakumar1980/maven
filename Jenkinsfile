pipeline
{
    ...
    stages
    {
        ...
        stage('ContinuousDownload')
        {
            steps
            {
                git 'https://github.com/intimesolutions/maven.git'
            }
        }
        ...
        stage('ContinuousTesting')
        {
            steps
            {
               git 'https://github.com/intimesolutions/FunctionalTesting.git'
    ...
    post
    {
        ...
        failure
        {
            mail bcc: '', body: 'Continuous Integration has failed', cc: '', from: '', replyTo: '', subject: 'CI Failed', to: 'mounika@intimesolutions.com'
        }
